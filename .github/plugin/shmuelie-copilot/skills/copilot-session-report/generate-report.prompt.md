---
description: "Generate a comprehensive session report for the current or a specified session. Covers tools, skills, MCPs, problem/solution, files, testing, learnings, tool assessments, and pending work."
---
...
2. **Run all 10 queries** from the skill against `session_store_sql`
...
4. **Fill in the template** sections:
   ...
   - Tools/Skills/MCPs breakdown with purpose annotations
   ...
   - Tool assessment — evaluate Hyperloop, VMs, or other tools that were or weren't used
   - Pending work items
